...
/**
 * Helper methods related to requesting and receiving stories data from The Guardian.
 */
...
public final class QueryUtils {
    ...
    public static List<News> fetchNewsData(String requestUrl) {
        ...
        // Extract relevant field the JSON response and create a list of {@link News}
    ...
    /**
     * Return a list of {@link News} objects has been built from
    ...
    private static List<News> extractFeatureFromJson(String newsJSON) {
        ...
        try {
            ...
            // which represents a list of features (or news stories).
            JSONArray newsArray = responseObject.getJSONArray("results");

            // For each news story in the newsArray, create an {@link News}
            for (int i = 0; i < newsArray.length(); i++) {

                // Get a single story news at position i within the list of news stories
                ...
                // Create a new {@link News} object with the title, section and url from
                // the JSON response.
