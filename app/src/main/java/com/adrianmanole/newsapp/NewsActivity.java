...
public class NewsActivity extends AppCompatActivity
    ...
    /**
     * URL for news stories from "The Guardian" query
     */
    private static final String GUARDIAN_REQUEST_URL = "http://content.guardianapis.com/search?q" +
            "=debates&api-key=test";

    /**
     * Constant value for the news stories loader ID.
     */
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (networkInfo != null && networkInfo.isConnected()) {
            ...
            // for bundle. Pass in this activity for the LoaderCallbacks parameter (which is valid
